 ...
 * - wantAuthnRequestsSigned optional, value for WantAuthnRequestsSigned attribute
 * - allowCertWhitespace optional, true to allow whitespace in certificate keys
 *
...
function metadataMiddleware (options) {
  ...
  var pem = encoders.removeHeaders(options.cert, options.allowCertWhitespace);
  var wantAuthnRequestsSigned = (options.wantAuthnRequestsSigned || false) ? "true" : "false";
